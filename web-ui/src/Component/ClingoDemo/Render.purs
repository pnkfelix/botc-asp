...
render state =
  ...
  HH.div
    ...
    , HH.div
        ...
        , -- Ground button (experimental - tests if we can extract ground program)
          HH.button
            ...
            , HP.title "Experimental: Try --text option (10s timeout)"
            ]
    ...
    -- Ground result display (experimental)
...
-- | Render the ground program result (experimental feature)
-- | Shows raw output from clingo-wasm when using --text option
    ...
    Just result ->
      HH.div
        ...
        , HH.p
            ...
            [ HH.text "Testing clingo-wasm with --text option to see if ground program extraction is possible" ]
        , HH.pre
